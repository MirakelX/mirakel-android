...
public class SimpleDragSortCursorAdapter extends ResourceDragSortCursorAdapter {
	 ...
	 */
	@Deprecated
	public SimpleDragSortCursorAdapter(final Context context, final int layout,
	 ...
	 */
	public SimpleDragSortCursorAdapter(final Context context, final int layout,
			final Cursor c, final String[] from, final int[] to, final int flags) {
	...
	public void setCursorToStringConverter(
			final CursorToStringConverter cursorToStringConverter) {
	 ...
	 *            parameter. Can be null if the cursor is not available yet.
	 */
	public void changeCursorAndColumns(final Cursor c, final String[] from,
			final int[] to) {
		this.mOriginalFrom = from;
		this.mTo = to;
	...
	public static interface ViewBinder {
		 ...
		 */
		boolean setViewValue(final View view, final Cursor cursor,
	...
	public static interface CursorToStringConverter {
		 ...
		 * @return a non-null CharSequence representing the cursor
		 */
		CharSequence convertToString(final Cursor cursor);
	}
