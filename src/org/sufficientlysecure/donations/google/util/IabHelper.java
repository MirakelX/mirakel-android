...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        checkNotDisposed();
        if (this.mSetupDone) throw new IllegalStateException("IAB helper is already set up.");
        ...
        this.mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                if (IabHelper.this.mDisposed) return;
                ...
                try {
                    ...
                    int response = IabHelper.this.mService.isBillingSupported(3, packageName, ITEM_TYPE_INAPP);
                    ...
                    response = IabHelper.this.mService.isBillingSupported(3, packageName, ITEM_TYPE_SUBS);
                    if (response == BILLING_RESPONSE_RESULT_OK) {
    ...
    public void dispose() {
        ...
        if (this.mServiceConn != null) {
            ...
            if (this.mContext != null) this.mContext.unbindService(this.mServiceConn);
        }
        this.mDisposed = true;
        this.mContext = null;
    ...
    private void checkNotDisposed() {
        if (this.mDisposed) throw new IllegalStateException("IabHelper was disposed of, so it cannot be used.");
    }
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        IabResult result;
        if (requestCode != this.mRequestCode) return false;
        ...
        if (data == null) {
            ...
            if (this.mPurchaseListener != null) this.mPurchaseListener.onIabPurchaseFinished(result, null);
            return true;
        }
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            try {
                ...
                if (!Security.verifyPurchase(this.mSignatureBase64, purchaseData, dataSignature)) {
                    ...
                    if (this.mPurchaseListener != null) this.mPurchaseListener.onIabPurchaseFinished(result, purchase);
                    return true;
                }
    ...
    void flagStartAsync(String operation) {
        if (this.mAsyncInProgress) throw new IllegalStateException("Can't start async operation (" +
                operation + ") because another async operation(" + this.mAsyncOperation + ") is in progress.");
    ...
    void logDebug(String msg) {
        if (this.mDebugLog) Log.d(this.mDebugTag, msg);
    }
