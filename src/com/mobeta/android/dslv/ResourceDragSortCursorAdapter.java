...
public abstract class ResourceDragSortCursorAdapter extends
	 ...
	 */
	@Deprecated
	public ResourceDragSortCursorAdapter(final Context context,
			final int layout, final Cursor c) {
		super(context, c);
	 ...
	 */
	public ResourceDragSortCursorAdapter(final Context context,
			final int layout, final Cursor c, final boolean autoRequery) {
	 ...
	 */
	public ResourceDragSortCursorAdapter(final Context context,
			final int layout, final Cursor c, final int flags) {
	...
	@Override
	public View newDropDownView(final Context context, final Cursor cursor,
			final ViewGroup parent) {
