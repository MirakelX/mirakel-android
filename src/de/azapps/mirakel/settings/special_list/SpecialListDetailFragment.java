...
import de.azapps.mirakel.settings.special_list.dialogfragments.EditDialogFragment;
import de.azapps.mirakel.settings.special_list.helper.SpecialListsConditionAdapter;

/**
 * A fragment representing a single SpecialList detail screen.
 * This fragment is either contained in a {@link SpecialListListActivity}
 * in two-pane mode (on tablets) or a {@link SpecialListDetailActivity}
 * on handsets.
 */
public class  SpecialListDetailFragment extends Fragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM)) {
            ...
            mItem = SpecialList.newSpecialList("Dummy", Optional.<SpecialListsBaseProperty>absent(), false);
        }
