...
public class DefinitionsHelper {
	...
	public static String MAIN_EXTRA_ID = "de.azapps.mirakel.EXTRA_TASKID";
	public static String MAIN_SHOW_TASK = "de.azapps.mirakel.SHOW_TASK";
	public static String MAIN_SHOW_LIST = "de.azapps.mirakel.SHOW_LIST";
	public static String MAIN_SHOW_LISTS = "de.azapps.mirakel.SHOW_LISTS";
	public static String MAIN_SHOW_LIST_FROM_WIDGET = "de.azapps.mirakel.SHOW_LIST_FROM_WIDGET";
	public static String MAIN_ADD_TASK_FROM_WIDGET = "de.azapps.mirakel.ADD_TASK_FROM_WIDGET";
	public static String MAIN_SHOW_TASK_FROM_WIDGET = "de.azapps.mirakel.SHOW_TASK_FROM_WIDGET";
	public static String MAIN_TASK_ID = "de.azapp.mirakel.TASK_ID";
